...
function addMsg(box,text,type){const d=document.createElement('div');d.className='message '+type;d.textContent=text;box.append(d);box.scrollTop=box.scrollHeight;return d}
